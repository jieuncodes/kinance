...
export const MarketMenuUl = tw.ul`grid gap-3 p-6 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr] bg-black/80`;
export const MarketMenuBanner = tw.li`row-span-3 banner-bg  bg-cover bg-no-repeat`;
export const MarketAnchor = tw.a`flex h-full w-full select-none flex-col justify-end rounded-md bg-gradient-to-b from-muted/50 to-muted p-6 no-underline outline-none focus:shadow-md`;
